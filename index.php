...
<html lang="en">
  <head>
    ...
    <title>UniCart - eCommerce Website</title>
          ...
          <form action="#">
            <div class="newsletter-header">
              ...
              <p class="newsletter-desc">
                Subscribe the <b>UniCart</b> to get latest products and discount
                update.
              </p>
            </div>
  ...
  -->
    ...
    <header>
        ...
        <div class="container">
          ...
          <div class="header-top-actions">
            ...
            <select name="language">
              ...
              <option value="es-ES">Indonesia</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="mobile-bottom-navigation">
        ...
        <button class="action-btn" class="addtocart">
          <ion-icon name="bag-handle-outline">h</ion-icon>
          <span class="count">+99</span>
          ...
          <div class="slider-container has-scrollbar">
            <div class="slider-item">
              ...
              <div class="banner-content">
                ...
                <p class="banner-text">Mulai dari Rp : <b>200</b>.000</p>
            ...
            <div class="slider-item">
              ...
              <div class="banner-content">
                ...
                <p class="banner-text">Mulai dari Rp: <b>150</b>.000</p>
            ...
            <div class="slider-item">
              ...
              <div class="banner-content">
                <p class="banner-subtitle">Penawaran Terbatas!</p>

                <h2 class="banner-title">New fashion summer sale</h2>

                <p class="banner-text">Mulai dari Rp: <b>299</b>.500</p>
                ...
                <div class="showcase-container">
                  <div class="showcase">
                    ...
                    <div class="showcase-content">
                      ...
                      Rasakan kesegaran menyeluruh dengan Hair & Skin Care Pack kami! Kombinasi sempurna dari conditioner yang melembutkan, shampoo yang membersihkan secara mendalam, dan facewash yang menyegarkan. Dapatkan perawatan rambut dan kulit wajah terbaik dalam satu paket praktis untuk menjaga kecantikan alami Anda setiap hari!
                      </p>
                      ...
                      <button class="add-cart-btn">Tambah Kekeranjang</button>
                      ...
                      <div class="countdown-box">
                        <p class="countdown-desc">Penawaran berakhir pada:</p>
                ...
                <div class="showcase-container">
                  <div class="showcase">
                    ...
                    <div class="showcase-content">
                      ...
                      <p class="showcase-desc">
                      Rose Gold Diamond Earrings kami memancarkan keanggunan dan kemewahan. Dibuat dari emas mawar berkualitas tinggi dengan sentuhan berlian asli yang berkilau, anting ini adalah perpaduan sempurna antara kemewahan modern dan keindahan klasik. Desainnya yang elegan cocok untuk segala kesempatan, menambah pesona glamor pada penampilan Anda. Berikan sentuhan istimewa dengan anting yang memukau dan abadi ini, sempurna untuk melengkapi koleksi perhiasan Anda atau sebagai hadiah tak terlupakan
                      </p>

                      <div class="price-box">
                        <p class="price">Rp. 4,899.000</p>
                        <del>Rp. 5,499.000</del>
                      </div>
  ...
  <div class="showcase-banner">
    ...
    <div class="showcase-actions">
      ...
      <button class="btn-action" onclick="addToCart(); return false;">
  ...
  <div class="showcase-content">
    <a href="jacket.html" class="showcase-category">jacket</a>
...
<script>
    function addToCart() {
        ...
        console.log("Keranjang setelah:", cart);
          ...
          -->
            ...
            <div class="testimonial">
              ...
              <div class="testimonial-card">
                ...
                <p class="testimonial-name">Erick Tohir</p>

                <p class="testimonial-title">CEO & Mentri BUMN</p>
                ...
                Belanja memuaskan! Barang sesuai deskripsi, kualitas bagus, pengiriman cepat, dan pelayanannya ramah. Produk melebihi ekspektasi dengan harga terjangkau. Pasti akan belanja lagi. Recommended!
                </p>
              </div>
            </div>
          ...
          -->
            ...
            <div class="cta-container">
              ...
              <a href="#" class="cta-content">
                <p class="discount">Diskon 25%</p>

                <h2 class="cta-title">Koleksi Musim Panas</h2>

                <p class="cta-text">Mulai Dari Rp. 49.000</p>
              ...
              <div class="service-container">
                <a href="#" class="service-item">
                  ...
                  <div class="service-content">
                    <h3 class="service-title">Pengiriman Luar Negeri</h3>
                    <p class="service-desc">Untuk Pesanan Lebih Dari Rp. 1.999,000</p>
                  </div>
                </a>
                ...
                <a href="#" class="service-item">
                  ...
                  <div class="service-content">
                    <h3 class="service-title">Pengiriman Besok</h3>
                    <p class="service-desc">Khusus JABODETABEK</p>
                  </div>
                </a>
                ...
                <a href="#" class="service-item">
                  ...
                  <div class="service-content">
                    <h3 class="service-title">Gratis Ongkir</h3>
                    <p class="service-desc">Untuk Seluruh Wilayah Indonesia</p>
                  </div>
                </a>
                ...
                <a href="#" class="service-item">
                  ...
                  <div class="service-content">
                    <h3 class="service-title">Pengembalian</h3>
                    <p class="service-desc">Gratis pengembalian</p>
                  </div>
                </a>
                ...
                <a href="#" class="service-item">
                  ...
                  <div class="service-content">
                    <h3 class="service-title">Voucher Cashback</h3>
                    <p class="service-desc">Hingga 100%</p>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div class="blog-container has-scrollbar">
            <div class="blog-card">
              ...
              <div class="blog-content">
                ...
                <a href="#">
                  <h3 class="blog-title">
                    Clothes Retail KPIs 2024 Guide for Clothes Executives.
                  </h3>
                </a>
    ...
    <footer>
          ...
          <ul class="footer-nav-list">
            ...
            <li class="footer-nav-item flex">
              ...
              <address class="content">
                Jl buaran indah No.15, Jakarta(JKT), 15590, INA
              </address>
            </li>
            ...
            <li class="footer-nav-item flex">
              ...
              <a href="mailto:example@gmail.com" class="footer-nav-link"
                >Costumer Services@UniCart.com</a
              >
            </li>
          </ul>
      ...
      <div class="footer-bottom">
        <div class="container">
          ...
          <p class="copyright">
            Copyright &copy; <a href="#">UniCart</a> all rights reserved. 
          </p>
        </div>
      </div>
    </footer>
